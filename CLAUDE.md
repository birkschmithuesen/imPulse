...
Impuls-Verhalten, Song-Struktur) statt einer langen Liste. Welche Adresse in welchen Tab
...
`build_speed_classes`, `build_song_structure`, `sc_param_groups` in
`server.py`), das Aussehen macht `app.js`:
