...
`sc_param_groups` in `server.py`), das Aussehen macht `app.js`. Dazu kommt die
Sektion „Split-Verhalten" im Tab **Noten-Verhalten**, die unter „Split-Anzahl
und Split-Versatz" beschrieben ist:
