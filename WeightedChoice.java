...
//
// Herausgezogen aus SpeedQuantizer.pick(), weil die Song-Struktur-Ebene
// dieselbe Rechnung braucht: dort ist es eine Zeile der Uebergangsmatrix
// (vier Gewichte), hier die fuenf Speed-Klassen. Zwei Kopien derselben
// Schleife waeren zwei Orte, an denen "Gewicht 0 wird nie gezogen"
// auseinanderlaufen kann - und genau diese Eigenschaft ist an beiden Stellen
// die, auf die man sich verlaesst.
//
...
class WeightedChoice {
  ...
  // ohnehin (die 1x-Klasse, das Level "mittel").
