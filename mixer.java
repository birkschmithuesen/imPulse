...
class Mixer {
	...
	public LedColor[] mix() {
		...
		for (int i = 0; i < effectList.size(); i++) {
			 ...
			 */
			LedColor.LedAlphaMode blendMode = LedColor.LedAlphaMode.ADD; // sets the blendmode, how the effect output is
		...
		// LedColor.substract(outputBufferLedColors, new LedColor(0.05,0.002,0.03));
		// //colored master fade out
