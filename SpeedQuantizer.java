...
class SpeedQuantizer {
  ...
  //
  // Die Schleife selbst steht in WeightedChoice: die Song-Struktur-Ebene zieht
  // ihre Uebergaenge nach genau derselben Regel, und zwei Kopien davon waeren
  // zwei Orte, an denen "Gewicht 0 wird nie gewaehlt" auseinanderlaufen kann.
